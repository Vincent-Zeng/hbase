...
public interface HRegionInterface extends VersionedProtocol {
     ...
     * @throws IOException
     */
    public byte[][] get(final Text regionName, final Text row, final Text column, final int numVersions)
            throws IOException;
     ...
     */
    public byte[][] get(
            final Text regionName, final Text row,
    ...
    public long openScanner(
            Text regionName, Text[] columns, Text startRow,

...
public class Leases {
    ...
    public Leases(final int leasePeriod, final int leaseCheckFrequency) {
        ...
        // zeng: 租约过期检测线程
        this.leaseMonitorThread = new LeaseMonitor(this.leaseCheckFrequency, this.stop);
     ...
     */
    public void createLease(final long holderId, final long resourceId, final LeaseListener listener) {
        LeaseName name = null;
...
//    }
    ...
    private class Lease implements Comparable {
        ...
        void expired() {
            LOG.info(Thread.currentThread().getName() + " lease expired " + getLeaseName());

            // zeng: LeaseListener.leaseExpired
